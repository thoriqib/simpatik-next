...
-- ═══════════════════════════════════════════════════════════════
-- FIX AKAR MASALAH: Insert Pengaduan & Permintaan Data via SECURITY
-- DEFINER function — hindari kegagalan "INSERT ... RETURNING" saat
-- role publik tidak punya izin SELECT (lihat catatan lengkap di
-- migration 0025_fix_akar_masalah_rls_returning.sql).
-- ═══════════════════════════════════════════════════════════════
