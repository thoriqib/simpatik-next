...
/**
 * Menampilkan link halaman lacak/chat pengaduan (yang dilihat pengadu)
 * untuk admin — supaya bisa buka langsung untuk verifikasi, atau salin
 * linknya. Adaptasi dari LinkLacakCard (permintaan data), path berbeda.
 */
export function LinkLacakPengaduanCard({ token }: { token: string }) {
